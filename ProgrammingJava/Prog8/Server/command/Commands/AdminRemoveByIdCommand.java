 ...
 */
public class AdminRemoveByIdCommand extends Command {
    /**
     ...
     */
    public AdminRemoveByIdCommand(CollectionManager manager, CollectionDatabaseManager cdm){
        super("remove_id");
    ...
    public void execute(String[] args, PrintStream printStream, UserData userData, Lock lock) throws CannotExecuteCommandException, SQLException {
        ...
        try {
            ...
            if (manager.containsId(id)) {
                ...
                printStream.println("Билет с ID = " + id + " был удален.");
