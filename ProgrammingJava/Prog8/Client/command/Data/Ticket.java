...
public class Ticket implements Validateable, Serializable {
    @Serial
    private final static long serialVersionUID = 59361893193717L;
    /**
    ...
    public Ticket(Long id, String name,Coordinates coordinates,LocalDateTime creationDate,Long price, boolean refundable, TicketType type, Event event, String owner){
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
        this.price =price;
    ...
    public boolean validate() {
        return (id != null) && (id > 0) && (name != null) &&
                ...
                (creationDate != null) && (price ==null || (price!=null && price > 0 )) && (type != null) &&
    ...
    public int compareTo(Ticket ticket) {
        return Long.compare(this.price,ticket.getPrice());
    }
}